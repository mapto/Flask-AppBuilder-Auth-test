...
Usage:
	fab-getparam-test --help
	fab-getparam-test [options]
...
from webapp.security import NoSecurityManager
...
local_app = create_app(config_name=config_name, security_manager_class=NoSecurityManager)
